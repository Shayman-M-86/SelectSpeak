...
| E | `PlaybackController` | D stable | Ready | Simplify overlapping synchronization/state behind Package D's stable request-event contract without pulling in audio migration. |
