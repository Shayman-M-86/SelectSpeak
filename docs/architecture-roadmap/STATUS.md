...
| I | Async UI delivery | Before native played-word callbacks | Ready | Make played-word/UI delivery non-blocking before Package J introduces native played-word callbacks. Keep scope to delivery; no broad WinUI cleanup. |
