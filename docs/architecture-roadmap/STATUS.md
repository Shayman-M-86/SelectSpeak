...
| G | PCM abstraction | C Complete with contract Frozen | Ready | Establish `PcmPlaybackSession` over the stable Package F declarations without coupling speech backends directly to ctypes or WaveOut. |
