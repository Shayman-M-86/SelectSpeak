...
$playerRuntimeInstaller = Join-Path $buildToolsRoot "runtime\install_player_runtime.ps1"
...
$playerRuntimeInstaller = (Resolve-Path -LiteralPath $playerRuntimeInstaller).Path
...
$compilerArguments = @(
    ...
    "/DPlayerRuntimeInstaller=$playerRuntimeInstaller",
